...
import { Professional, User, adminData, adminLogin } from "../types/admin.types";


// Admin login
export const adminLoginAction = createAction(`[Admin component] Admin login`, props<{formData : adminLogin}>())
...
export const loadTotalProfessionalsSuccess = createAction(`[Admin component] Load total professionals success`, props<{user : Professional[]}>())
...
export const loadTotalRequestProfessionalsSuccess = createAction(`[Admin component] Load total Request professionals success`, props<{user : Professional[]}>())
...
export const loadProfessionalsSuccess = createAction(`[Admin component] Load professionals success`, props<{user : Professional[]}>())
...
export const loadRequestProfessionalsSuccess = createAction(`[Admin component] Load Request professionals success`, props<{user : Professional[]}>())
