...
import {
  selectLoadingTotalRequestProfessionals,
  selectRequestProfessional,
  selectTotalRequestProfessional,
} from '../../store/admin.selector';
import {
  approveProfessionals,
  loadRequestProfessionals,
...
export class ProfessionalRequestsComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.professionalSubscription = this.store
      .pipe(select(selectRequestProfessional))
      .subscribe((professionals) => {
        this.professionals$ = professionals as Professional[];
      });
    this.loadingSubscription = this.store
      .pipe(select(selectLoadingTotalRequestProfessionals))
      .subscribe((loading) => {
