...
export const selectCompletedTaskState = createFeatureSelector<taskInitialState>('usercompletedTask')
...
export const selectInprogressScheduleState = createFeatureSelector<ScheduleInitialState>('userInprogressSchedule')
...
export const selectCompletedScheduleState = createFeatureSelector<ScheduleInitialState>('userCompletedSchedule')
