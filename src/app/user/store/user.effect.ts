...
export class UserEffects {
    ...
    return this.actions$.pipe(
      ...
      mergeMap((payload) =>
        this.userService.userLogin(payload.data).pipe(
          ...
          catchError((error) =>
            of(UserActions.loginUserFailure({ error: error.error })),
          ),
        ),
      ),
    );
    ...
    return this.actions$.pipe(
      ...
      mergeMap((payload) =>
        this.userService.userRegister(payload.userData).pipe(
          ...
          catchError((error) =>
            of(UserActions.registerUserFailure({ error: error.error })),
          ),
        ),
      ),
    );
  ...
  forgetPassword$ = createEffect(() => {
    return this.actions$.pipe(
      ...
      mergeMap((paylod) => {
        return this.userService.sendForgotPasswordMail(paylod.email).pipe(
          map((message: string) => {
            return UserActions.forgotEmailUserSuccess({ message });
          }),
          catchError((error) =>
            of(UserActions.forgotEmailUserFailure({ error: error })),
          ),
        );
      }),
    );
    ...
    return this.actions$.pipe(
      ...
      mergeMap((payload) => {
        return this.userService
          .newPassword(payload.token, payload.password)
          .pipe(
            map((user: userData) => {
            ...
            catchError((error) =>
              of(UserActions.newPasswordFailure({ error: error })),
            ),
          );
      }),
    );
    ...
    return this.actions$.pipe(
      ...
      mergeMap((payload) =>
        this.userService.getUserDetailsByToken(payload.token).pipe(
          map((user: userData) =>
            UserActions.getUserDetailsByTokenSuccess({ userData: user }),
          ),
          catchError((error) =>
            of(UserActions.getUserDetailsByTokenFailure({ error: error })),
          ),
        ),
      ),
    );
      ...
      mergeMap((payload) => {
        return this.userService.getProfessionalDataByEmail(payload.email).pipe(
          map((user: professionalData) =>
            UserActions.getProfessionalDataSuccess({ userData: user }),
          ),
          catchError((error) =>
            of(UserActions.getProfessionalDataFailure({ error: error })),
          ),
        );
      }),
    );
    ...
    return this.actions$.pipe(
      ...
      mergeMap((payload) =>
        this.userService.getProfessionals().pipe(
          map((data) =>
            UserActions.getProfessionalsSuccess({ professionals: data.data }),
          ),
          catchError((error) =>
            of(UserActions.getProfessionalsFailure({ error: error })),
          ),
        ),
      ),
    );
    ...
    return this.actions$.pipe(
      ...
      mergeMap((payload) =>
        this.userService.getInProgressTask(payload.page).pipe(
          map((data) =>
            UserActions.getInprogressTaskSuccess({
              tasks: data.data,
              total: data.total,
            }),
          ),
          catchError((error) =>
            of(UserActions.getInprogressTaskFailure({ error: error })),
          ),
        ),
      ),
    );
    ...
    return this.actions$.pipe(
      ...
      mergeMap((payload) =>
        this.userService.getCompletedTask(payload.page).pipe(
          map((data) =>
            UserActions.getCompletedTaskSuccess({
              tasks: data.data,
              total: data.total,
            }),
          ),
          catchError((error) =>
            of(UserActions.getCompletedTaskFailure({ error: error })),
          ),
        ),
      ),
    );
    ...
    return this.actions$.pipe(
      ...
      mergeMap((payload) =>
        this.userService.getInProgressMeeting(payload.page).pipe(
          map((data) => {
            return UserActions.getInprogressScheduleSuccess({
              meeting: data.data,
              total: data.total,
            });
          }),
          catchError((error) =>
            of(UserActions.getInprogressScheduleFailure({ error: error })),
          ),
        ),
      ),
    );
    ...
    return this.actions$.pipe(
      ...
      mergeMap((payload) =>
        this.userService.getCompletedMeeting(payload.page).pipe(
          map((data) =>
            UserActions.getCompletedScheduleSuccess({
              meeting: data.data,
              total: data.total,
            }),
          ),
          catchError((error) =>
            of(UserActions.getCompletedScheduleFailure({ error: error })),
          ),
        ),
      ),
    );
