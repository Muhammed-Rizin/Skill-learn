...
export class VideoComponent {
  ...
  toggleCamera = async () => {
    const videoTrack = this.localStream.getTracks().find(track => track.kind === 'video') as MediaStreamTrack
  ...
  toggleAudio = async () => {
    const audioTrack = this.localStream.getTracks().find(track => track.kind === 'audio') as MediaStreamTrack
