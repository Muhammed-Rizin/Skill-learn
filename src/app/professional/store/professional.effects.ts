...
export class professionalEffects {
    ...
    return this.actions$.pipe(
      ...
      mergeMap((payload) =>
        this.professionalService
          .professionalRegister(payload.professionalData)
          .pipe(
            map((data: professionalData) => {
              localStorage.setItem('professional_token', data.token);
              this.router.navigate(['/professional']);
              return professionalActions.professionalRegisterSuccess({
                professionalData: data,
              });
            }),
            catchError((error) =>
              of(
                professionalActions.professionalRegisterFailure({
                  error: error.error,
                }),
              ),
            ),
  ...
  loginUser$ = createEffect(() => {
    return this.actions$.pipe(
      ...
      mergeMap((payload) =>
        this.professionalService
          .professionalLogin(payload.professionalData)
          .pipe(
            map((data: professionalData) => {
              localStorage.setItem('professional_token', data.token);
              this.router.navigate(['/professional']);
              return professionalActions.professionalLoginSuccess({
                professionalData: data,
              });
            }),
            catchError((error) =>
              of(
                professionalActions.professionalLoginFailure({
                  error: error.error,
                }),
              ),
            ),
    ...
    return this.actions$.pipe(
      ...
      mergeMap((payload) => {
        return this.professionalService
          .sendForgotPasswordMail(payload.email)
          .pipe(
            map((message: string) => {
              return professionalActions.forgotEmailProfessionalSuccess({
                message,
              });
            }),
            catchError((error) =>
    ...
    return this.actions$.pipe(
      ...
      mergeMap((payload) =>
        this.professionalService.getProfessionalDetails(payload.token).pipe(
          ...
          catchError((error) =>
            of(
              professionalActions.getProfessionalDetailsFailure({
                error: error,
              }),
            ),
          ),
        ...
        return this.professionalService
          ...
          .pipe(
            map((user: professionalData) => {
              ...
              this.router.navigate(['/professional']);
              return professionalActions.newPasswordSuccess({
                professionalData: user,
              });
            }),
            catchError((error) =>
              of(professionalActions.newPasswordFailure({ error: error })),
            ),
          );
      }),
    );
    ...
    return this.actions$.pipe(
      ...
      mergeMap((payload) =>
        this.professionalService.getInProgressTask(payload.page).pipe(
          ...
          catchError((error) =>
            of(professionalActions.getInprogressTaskFailure({ error: error })),
          ),
        ),
      ),
    );
    ...
    return this.actions$.pipe(
      ...
      mergeMap((payload) =>
        this.professionalService.getCompletedTask(payload.page).pipe(
          ...
          catchError((error) =>
            of(professionalActions.getCompletedTaskFailure({ error: error })),
          ),
        ),
      ),
    );
    ...
    return this.actions$.pipe(
      ...
      mergeMap((payload) =>
        this.professionalService.getInProgressMeeting(payload.page).pipe(
          ...
          catchError((error) =>
            of(
              professionalActions.getInprogressScheduleFailure({
                error: error,
              }),
            ),
          ),
    ...
    return this.actions$.pipe(
      ...
      mergeMap((payload) =>
        this.professionalService.getCompletedMeeting(payload.page).pipe(
          ...
          catchError((error) =>
            of(
              professionalActions.getCompletedScheduleFailure({ error: error }),
            ),
          ),
        ),
      ),
