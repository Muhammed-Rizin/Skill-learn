...
export const selectRegisterState = createFeatureSelector<State>(
...
export const selectLoginState = createFeatureSelector<State>(
  'loginProfessionalState',
);
...
export const selectForgotPasswordState = createFeatureSelector<State>(
  'professionalForgotPasswordState',
);
...
export const selectInprogressTaskState =
  createFeatureSelector<taskInitialState>('professionalInprogressTask');
...
export const selectCompletedTaskState = createFeatureSelector<taskInitialState>(
  'professionalCompletedTask',
);
...
export const selectInprogressScheduleState =
  createFeatureSelector<ScheduleInitialState>('professionalInprogressSchedule');
...
export const selectCompletedScheduleState =
  createFeatureSelector<ScheduleInitialState>('professionalCompletedSchedule');
